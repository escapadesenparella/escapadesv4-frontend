...
const StoryEditionForm = () => {
			...
			const fetchData = async () => {
				...
				setState({
					...
					formData: {
						...
						blopCover: storyDetails.cover,
						updatedCover: false,
						images: storyDetails.images,
						blopImages: storyDetails.images,
						updatedImages: false,
						cloudImages: storyDetails.images,
						coverCloudImage: storyDetails.cover,
						isReadyToSubmit: false,
						cloudImagesUploaded: false,
						coverCloudImageUploaded: false,
	...
	const submitStory = async () => {
		...
		const storyCover = state.formData.updatedCover
			? coverCloudImage
			: cover;
		const storyImages = state.formData.updatedImages ? cloudImages : images;
